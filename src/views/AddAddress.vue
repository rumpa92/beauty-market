      ...
      <div class="market-container">
        <div class="progress-indicator">
          ...
          <div class="progress-step active">
            ...
            <span class="step-label">Address Type</span>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="form-container">
          <form @submit.prevent="saveAddress" class="address-form">
            ...
            <div class="form-section-header">
              ...
              <p class="section-subtitle">Enter your personal details for delivery</p>
            </div>
            ...
            <div class="form-section-header">
              ...
              <p class="section-subtitle">Provide complete address for accurate delivery</p>
            </div>
            ...
            <div class="form-row">
              <div class="form-group pincode-group">
                ...
                <div v-if="errors.pincode" class="field-error">
                  <i class="fas fa-exclamation-circle"></i>
              ...
              <div class="form-group">
                ...
                <div class="input-wrapper">
                  ...
                  <input 
                    ...
                    :class="{ error: errors.building }"
                  />
                </div>
                <div v-if="errors.building" class="field-error">
                  <i class="fas fa-exclamation-circle"></i>
            ...
            <div class="form-group">
              ...
              <div v-if="errors.street" class="field-error">
                <i class="fas fa-exclamation-circle"></i>
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <div v-if="errors.city" class="field-error">
                  <i class="fas fa-exclamation-circle"></i>
              ...
              <div class="form-group">
                ...
                <div v-if="errors.state" class="field-error">
                  <i class="fas fa-exclamation-circle"></i>
            ...
            <div class="form-section-header">
              ...
              <p class="section-subtitle">Choose how you'd like to identify this address</p>
            </div>
            ...
            <div class="additional-options">
              ...
              <div class="option-hint">
                ...
                <span>This address will be automatically selected for future orders</span>
              </div>
            </div>
          </form>
        </div>
      ...
      <div class="market-container">
        <div class="button-group">
          ...
          >
            ...
            <span>{{ isSaving ? 'Adding Address...' : 'Add Address' }}</span>
          </button>
        </div>
      </div>
    </div>
    ...
    <Transition name="toast">
      <div v-if="showToast" class="toast-notification success">
        <div class="toast-content">
          ...
          <span class="toast-message">Address added successfully</span>
        </div>
      </div>
    </Transition>
  </div>
...
export default {
  ...
  methods: {
    ...
    validateField(fieldName) {
      ...
      switch (fieldName) {
        ...
        case 'phone':
          ...
          } else if (!/^[\+]?[0-9\s\-\(\)]{10,15}$/.test(this.form.phone)) {
        ...
        case 'pincode':
          if (!this.form.pincode.trim()) {
            ...
            this.errors.pincode = 'Pincode must be 6 digits';
          }
          break;
          
        case 'building':
          if (!this.form.building.trim()) {
            this.errors.building = 'Building name/number is required';
          }
          break;
          
        case 'street':
          if (!this.form.street.trim()) {
            this.errors.street = 'Address line is required';
          } else if (this.form.street.trim().length < 10) {
            this.errors.street = 'Please provide a complete address';
          }
          break;
    ...
    validatePincode() {
      ...
      // Mock validation success with area detection
      this.pincodeValidation = {
        show: true,
        type: 'success',
        message: 'Pincode verified • Delivery available',
        icon: 'fas fa-check-circle'
      };
      
      // Auto-fill city and state based on pincode (mock data)
      if (pincode.startsWith('400')) {
        this.form.city = 'Mumbai';
        this.form.state = 'Maharashtra';
      } else if (pincode.startsWith('110')) {
        this.form.city = 'New Delhi';
        this.form.state = 'Delhi';
      } else if (pincode.startsWith('560')) {
        this.form.city = 'Bangalore';
        this.form.state = 'Karnataka';
      }
    },
    
    validateAllFields() {
      const fields = ['name', 'email', 'phone', 'pincode', 'building', 'street', 'city', 'state'];
    ...
    async saveAddress() {
      ...
      try {
        ...
        // In real app, this would save to API/store
